...
const RenderCards = ({ data, title }) => {
  ...
  return (
    <h2
      className='mt-5 font-bold text-[#6449ff] txt-xl uppercase'
    >
      { title }
    </h2>
  )
...
const Home = () => {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        <h1 
          className='font-extrabold text-[#222328] text-[32px]'>The Community Showcase
        </h1>
        <p
          className='mt-2 text-[#666e75] txt-[16px] max-w-[500px]'
        >
          Browse trough a collection of imaginative andvisually stunning images generated by DALL-E AI
        </p>
      </div>
